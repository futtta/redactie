...
if (isset($_GET["nocache"]) && $_GET["secret"]===$cacheSecret) {cache_delete(md5($url));}
...
function fetchUrl($url) {
	...
	if (strpos($url,$baseAPI)===0) {
        if (function_exists("curl_init")) {
            ...
            /* you don't need to tunnel out, do you?
