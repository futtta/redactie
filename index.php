...
if ($menu===false) {
	...
	$menu="<div class=\"footer\"><div class=\"nav\" id=\"nav\"><ul><li class=\"catHeader\">Categorie&euml;n<ul><li class=\"menuItem\"><a href=\"".$baseUrl."\">Hoofdpunten</a></li><li class=\"menuItem\"><a href=\"".$baseUrl."#nieuwsstroom\">Laatste Nieuws</a></li>";
	if (is_array($menuArr)){
...
if ($_GET["url"]){
        if (strpos($url,"http://m.deredactie.be/")===0) {
                $nothomepage=true;
                $url=$_GET["url"];
                $header="</head><body><div id=\"header\"><div id=\"back\"><a href=\"".$baseUrl."\">&lt;</a></div><div id=\"logo\"><a href=\"".$baseUrl."\">".$owner."'s</a><hr><span id=\"redactie\"><a href=\"".$baseUrl."\">redactie.be</a></span></div><div id=\"catTitle\"><span id=\"titleText\"></span></div></div><div id=\"content\">";
        }
}
